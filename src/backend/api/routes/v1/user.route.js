...
router
     ...
     * @apiDescription Update some fields of a user
     * @apiVersion 1.0.0
     * @apiName UpdateUser
     * @apiGroup User
     * @apiPermission user
     ...
     * @apiHeader {String} Authorization   User's access token
     *
     * @apiParam  {String{6..128}}     oldPassword  Previous user's password
     * @apiParam  {String{6..128}}     password     User's password
     * @apiParam  {String{..128}}      [name]       User's name
     * @apiParam  {String=user,admin}  [surname]    User's surname
     * @apiParam  {String=user,admin}  [phone]      User's phone
     * @apiParam  {String=user,admin}  [country]    User's country
     * @apiParam  {String=user,admin}  [region]     User's region
     * @apiParam  {String=user,admin}  [role]       User's role
